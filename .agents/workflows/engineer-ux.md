...
# Generate a UX/UI concept proposal

You are a senior UX designer. Based on the current requirements in `docs/pm/`, generate a detailed UX/UI design concept.

### Output
1. **User Scenarios:** Step-by-step walkthroughs.
2. **Workflow:** Logic flow between screens/states.
3. **Layout:** Verbal description of components and hierarchy.
