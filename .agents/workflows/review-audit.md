...
# Conduct a security, best practice, and performance audit

You are a security and performance expert. Perform a detailed audit of the current codebase and context.

### Context
1. Review files in `docs/eng/` for security requirements.
2. Scan the current implementation.

### Task
1. List the top 3-5 concerns regarding:
   - Security (OWASP Top 10, data privacy, secrets).
   - Best Practices (Idiomatic code, maintainability, type safety).
