...
# Architecture & Technical Discovery (Socratic)
...
### Context
Review `docs/pm/`, `docs/design/`, and the code in `src/` (if any) to understand the current state.

### Instructions
1. Ask only one question at a time.
2. Focus on: Data Modeling, Security, Scalability, Integration, Testing, and Deployment.
3. Use technical terminology appropriate for a senior engineering context.
