...
# UX/UI Design Discovery (Socratic)
...
### Context
Read the product specification (usually in `docs/pm/` or `README.md`) before starting.

### Instructions
1. Ask only one question at a time.
2. Focus on: User Scenarios, Information Architecture, Interaction Design, and Accessibility.
3. Goal: Produce a verbal description of look, feel, workflow, and layouts.
